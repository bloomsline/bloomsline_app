...
export const fr: Dict = {
  common: {
    ...
    retry: 'Réessayer',
    ok: 'OK',
    close: 'Fermer', zoomIn: 'Agrandir', zoomOut: 'Réduire', zoom: 'Zoom', fullScreen: 'Plein écran', exitFullScreen: 'Quitter le plein écran',
    play: 'Lecture', pause: 'Pause', voiceNote: 'Note vocale', previousMonth: 'Mois précédent', nextMonth: 'Mois suivant',
    previousDay: 'Jour précédent', nextDay: 'Jour suivant', somethingWrong: 'Une erreur s’est produite. Veuillez réessayer.',
  },
  tabs: {
    care: 'Mon Suivi',
    moments: 'Moments',
  ...
  invite: {
    ...
    tagline: 'Vos journées ont une forme. Ici, elle devient visible.',
  ...
  authLink: {
    ...
    providerReturn: {
      ...
      private_relay: 'Votre praticien a invité une autre adresse e-mail. Connectez-vous avec celle-ci, ou choisissez de partager votre e-mail avec Apple.',
      private_relay_email: 'Cette adresse est une adresse « Masquer mon e-mail » d’Apple, et votre praticien en a invité une autre. Connectez-vous avec l’adresse qu’il a invitée.',
    },
  ...
  signUp: {
    ...
    providerRejected: 'La connexion n’a pas fonctionné. Réessayez, ou utilisez votre e-mail.',
  },
  signUpCode: {
  ...
  settings: {
    ...
    homeCare: 'Mon suivi',
    homeMoments: 'Moments',
    legalSection: 'Confidentialité et conditions',
    privacyPolicy: 'Politique de confidentialité',
    termsOfUse: 'Conditions d’utilisation',
    dataProtection: 'Vos données',
    dataProtectionSub: 'Ce que nous conservons, et vos droits',
    security: 'Sécurité et hébergement',
    securitySub: 'Hébergeur de données de santé, en France',
    deleteAccount: 'Supprimer le compte',
    moreOptions: 'Plus d’options',
    madeBy: 'Fait avec soin par l’équipe Bloomsline',
  ...
  journal: {
    ...
    untitled: 'Sans titre',
    shared: 'Partagé',
    sharedWithOther: 'Partagé avec {name}',
  ...
  line: {
    ...
    refreshFailed: 'Actualisation impossible. Affichage de ce qui était déjà là. Touchez pour réessayer.',
    olderFailed: 'Impossible de charger les moments précédents. Touchez pour réessayer.',
  ...
  capture: {
    ...
    pracCannotSeeMany: '{prac} ne pourront pas le voir.',
    ...
    errTooLarge: 'Cette vidéo est trop lourde (plus de 100 Mo). Essayez un extrait plus court.',
    errCameraNeeded: 'L’accès à l’appareil photo est désactivé pour Bloomsline. Vous pouvez l’activer dans les Réglages du téléphone.',
    ...
    errShareNoPractitioner: 'Votre moment a été enregistré. Il n’a pas été partagé, car vous n’êtes lié à aucun praticien pour le moment.',
    takePhoto: 'Prendre une photo',
  ...
  care: {
    ...
    phoneCall: 'Votre praticien vous appellera',
    ...
    switchPractitioner: 'Changer',
    switchPractitionerA11y: 'Changer de praticien',
    failedShowing: 'Ceci est le suivi avec {name}. Vous pouvez réessayer, ou changer de praticien.',
    yourPractitioners: 'Vos praticiens',
    switchHint: 'Mon Suivi, les réservations et le partage suivent le praticien choisi.',
    nowShowing: 'Vous voyez maintenant le suivi avec {name}',
    fromName: 'De {name}',
