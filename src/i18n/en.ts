...
export const en = {
  ...
  capture: {
    ...
    makeBackground: 'Make this the background',
    isBackground: 'This is the background',
    removeMedia: 'Remove',
    tapToSetBackground: 'Tap one to make it the background.',
    isBackgroundHint: 'This is the background of your moment.',
